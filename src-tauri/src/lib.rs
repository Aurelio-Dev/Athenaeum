...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            windows::close_notebook_window,
            windows::close_reader_panel_window,
            windows::close_reader_window,
            delete_document_permanently,
            import_document,
            wallpaper::import_wallpaper,
            notebook_attachments::delete_notebook_file_attachment,
            canvas::load_canvas_files,
            notebook_assets::load_notebook_assets,
            notebook_attachments::load_notebook_file_attachments,
            open_document_externally,
            open_external_url,
            open_file_location,
            notebook_attachments::open_notebook_file_attachment,
            windows::open_notebook_window,
            windows::open_reader_panel_window,
            windows::open_reader_window,
            read_pdf_file,
            wallpaper::remove_wallpaper,
            wallpaper::resolve_wallpaper_path,
            notebook_attachments::reveal_notebook_file_attachment,
            canvas::save_canvas_file,
            notebook_assets::save_notebook_asset,
            notebook_attachments::save_notebook_file_attachment,
