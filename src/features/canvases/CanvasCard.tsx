  ...
  return (
    <>
      <article
        ...
        className="material-liquid-card material-surface-card group relative flex cursor-pointer flex-col overflow-hidden rounded-xl border border-[#E8DDD4] bg-surface-card shadow-card transition hover:-translate-y-1 dark:border-border-subtle"
      >
