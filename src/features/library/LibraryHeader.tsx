      ...
      <div className="flex items-center gap-3">
        ...
        {onEdit ? (
          <button
            type="button"
            onClick={onEdit}
            className="material-liquid-control inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-border-subtle bg-surface-panel text-text-secondary shadow-sm transition hover:text-text-primary"
