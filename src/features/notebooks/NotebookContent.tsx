...
// O conteudo entrega duas fatias para o dono da moldura encaixar nos slots
// dele: o header (o status de salvamento, o botao "i" e o menu de opcoes sao
// estado de conteudo, entao ele precisa ser renderizado por quem tem esse
// estado, dentro do slot de quem tem a moldura) e o corpo. O startDragging e
// opcional: a moldura passa undefined quando drag nao se aplica (painel
// maximizado; janela nativa nao passa nada) e o header nem liga o handler.
...
type NotebookContentProps = {
  ...
  // desenha-los — numa janela nativa o SO ja tem esses controles e a prop e
  // simplesmente omitida.
  frameHeaderActions?: ReactNode;
  // Painel minimizado: a area principal do corpo desmonta (vira null); header
...
export function NotebookContent({
  ...
  // quando ele e o ATIVO para atalhos (no painel flutuante: o topo da pilha),
  // para nao fechar varios paineis com um Esc.
