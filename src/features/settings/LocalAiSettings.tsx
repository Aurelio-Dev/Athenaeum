export function LocalAiSettings() {
  return (
    <section className="flex max-w-[580px] flex-col gap-4">
      <header>
        <h2 className="app-title font-serif text-xl font-medium">Use sua IA</h2>
      ...
      <div className="rounded-xl border border-border-subtle bg-surface-card p-5 shadow-card">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold uppercase tracking-[0.12em] text-primary-text">Somente IA local</span>
        </div>
